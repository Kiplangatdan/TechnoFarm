...
if(isset($_POST['add']))
	...
	if(empty($acreage)||empty($fuel)||empty($seeds))
	{
	...
	$sql = "INSERT INTO plant VALUES('$id','$acreage','$fertilizers','$date','$fuel','$seeds')";
...
<div id="cont">
	...
	<div id="accordion">
	     ...
	     <div>
			...
			<legend>	<h3><a href="#" style="color: yellowgreen;">Planting Details</a></h3></legend>
				<div>
                ...
                <?php
					...
					$g = mysql_query("select max(id) from plant"); //Count the number of Machines the table
				...
				?>
                        ...
                        <th><label>Fertilizers Used</label></th>
						<td><input type="text" name="fertilizers"/></td>
												
						</tr>
						
						<tr>
						<th><label>Seeds Planted</label></th>
						<td><input type="text" name="seeds" required="" placeholder="bags"></td>
