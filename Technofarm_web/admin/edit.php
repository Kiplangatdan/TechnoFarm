...
<div id="cont">
	...
	<table>
        ...
        <?php
       $i = mysql_query("update users set fname='".$_POST['fname']."', mname='".$_POST['mname']."', id_no='".$_POST['id_no']."', email='".$_POST['email']."', tel='".$_POST['tel']."', county='".$_POST['county']."',district='".$_POST['district']."',password='".$_POST['password']."',category='".$_POST['category']."',date='".$_POST['date']."',gender='".$_POST['gender']."' where id=".$_POST['id']);
        if($i==true){
