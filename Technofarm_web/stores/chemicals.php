...
if(isset($_POST['add']))
	...
	if($result > 0){
		@ $error.= "The chemicals details has been added successfully!";
		}
	else{
	     ...
	     <div>
			...
			<legend>	<h3><a href="#" style="color: yellowgreen;">Farm Chemicals Details</a></h3></legend>
                ...
                <?php
					...
					$g = mysql_query("select max(id) from chemicals"); 
...
<center>
        ...
        <?php
        $sql = mysql_query("select sum(quantity) from chemicals;");
		...
		?>
		<tr>
        <?php echo ("Total Quantity = " . $sum . " Litres");?>
