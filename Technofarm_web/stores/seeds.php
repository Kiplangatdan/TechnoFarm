...
if(isset($_POST['add']))
	...
	$sql = "INSERT INTO seeds VALUES('$id','$description','$quantity','$price','$date','$category')";
	$query = mysql_query($sql);
	$result = mysql_affected_rows();
	if($result > 0){
		@ $error.= "The seed details has been successfuly entered";
		}
	else{
		$error.="The Item(s) Could not be added!!";
	}
	}
}
?>
...
<div id="cont">
	...
	<div id="accordion">
	     ...
	     <div>
			...
			<legend>	<h3><a href="#" style="color: yellowgreen;">Seed Details</a></h3></legend>
				<div>
                ...
                <?php
					...
					$g = mysql_query("select max(id) from seeds"); //Count the number of Machines the table
				...
				?>
						...
						<td><input type="text" name="description" autofocus="" required=""></td>
